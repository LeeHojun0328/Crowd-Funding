...
/*
	$('input.registerProjectBtn').click(function(){
		if($('input.projectName').val() == "" || $('textarea.projectDesc').val() ==""){
			...
			var fd = new FormData();
			var file = $('input.projectImg')[0].files[0];
			fd.append('file',file);
			...
			console.log(arr);
			/*
			$('.registerproject-container form').submit(function(event){
				alert('ajaxForm');
				event.preventDefault();
				var data = $('.registerproject-container form').serialize()+'hi=hi';
				...
				data: {
                    ...
                    projectDesc: $('textarea.projectDesc').val();
                    projectImg: fd;
                    reward: arr;
                    contractName: $('input.contractName').val();
                    goalPrice: $('input.goalPrice').val();
                    goalDate: $('input.goalDate').val();
                }
			}); */
	...
	/*		$.ajax({
        	    ...
        	    data: {
					projectName: $('input.projectName').val(),
					projectDesc: $('textarea.projectDesc').val(),
					projectImg: new FormData($('input.projectImg')[0]),
					reward: arr,
					contractName: $('input.contractName').val(),
					goalPrice: $('input.goalPrice').val(),
					goalDate: $('input.goalDate').val()
